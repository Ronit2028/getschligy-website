 <div class="sub_banner">
		<img src="<?php echo base_url(); ?>assets/images/sub-banner.png" class="img-responsive">
		<div class="centered">Disclaimer</div>
        </div>

<div class="container inner ssaa" style="padding:40px 15px;">

<p class="text-justify">
    The information contained in this website is for general information purposes only.
    The information is provided by Compony and while we endeavor to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability or availability with respect to the website or the information, products, services, or related graphics contained on the website for any purpose.
    ...
    Every effort is made to keep the website up and running smoothly. However, Compony., takes no responsibility for, and will not be liable for, the website being temporarily unavailable due to technical issues beyond our control.
