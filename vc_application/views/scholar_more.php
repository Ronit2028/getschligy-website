...
?>
		...
		<div class="rs-breadcrumbs breadcrumbs-overlay About">
				...
				<a href="#">
                    <h1 class="page-title">Other Govt. Scholarship Schemes</h1>
					</a>
					<ul>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-5 padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
							<?php if($get_schloshipss[0]['image'] !='') { echo '<img src="'.base_url().'main-admin/images/'.$get_schloshipss[0]['image'].'">'; }else{echo '<img src="'.base_url().'main-admin/images/1.jpg">';} ?>
							</div>
						</div>
						<div class="col-lg-7 pr-70 md-pr-15">
							<div class="sec-title">
								<h2 class="title mb-17"><?php echo $get_schloshipss[0]['title'];?></h2>
								<div class="bold-text mb-22"><?php echo $get_schloshipss[0]['discription'];?></div>
							</div>
							<div class="btn-part">
