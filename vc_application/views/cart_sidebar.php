  ...
  <tr>										
  <td>Total PV</td>
  <td><?php echo $this->session->userdata('tt_lbv');?></td>
  </tr>	
 ...
 <tr class="discount">	
  <td>Discount</td>
  <td>Rs. <?php echo $this->session->userdata('coupon_val')+0; ?></td>
  </tr>	  
 <!--  <tr class="shipping-cost">	
  <td>GST</td>
  <td>Rs. <?php echo round($this->session->userdata('order_tax'));?></td>
  </tr> -->	
  <tr>
  <td>Total</td>	
  <td><span>Rs. <?php echo round($this->session->userdata('order_total'));?></span></td>
  </tr>	
