...
class Product_model extends CI_Model {
    ...
    */
    ...
    public function get_all_ecommerce()
    {
        $this->db->select('*');
  ...
  public function get_all_product_id($id)
	...
	public function get_all_ecommerce_product_id($id)
    {
        $this->db->select('*');
        $this->db->from('admin_product');
        $this->db->where('id',$id);
 ...
 function store_ecommerce_product($data)
    {
    ...
    */
    ...
    function update_ecommerce_product($id, $data)
        {
            $this->db->where('id', $id);
    ...
    */
    ...
    function delete_ecommerce_product($id){
        $this->db->where('id', $id);
