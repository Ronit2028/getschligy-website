      ...
      ?>
		...
		<div class="form-group col-sm-12">
          ...
          <label  class="control-label col-sm-3">Aadhar image <small style="color:red"></small></label>
             <div class="col-sm-9">   
			 <?php if($prod['aadharimage'] !='') { echo '<a href="http://www.blisszon.com/images/user/'.$prod['aadharimage'].'" target="_blank"><img src="http://lamlordventures.com/images/user/'.$prod['aadharimage'].'" style="width:auto;max-width:250px;"></a>'; } ?>
          </div>
          </div>
		 ...
		 <div class="form-group col-sm-12">
          <label  class="control-label col-sm-3">PAN image <small style="color:red"></small></label>
             <div class="col-sm-9">   
			 <?php if($prod['panimage'] !='') { echo '<a href="http://lamlordventures.com/images/user/'.$prod['panimage'].'" target="_blank"><img src="http://lamlordventures.com/images/user/'.$prod['panimage'].'" style="width:auto;max-width:250px;"></a>'; } ?>
          </div>
          </div>
