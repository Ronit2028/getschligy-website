...
<thead> <tr><th>S No.</th> <th>Title</th><th>Type</th><th>Status</th><th>Delete</th> </tr> </thead> 
<tbody> 
<?php 
$i = 1;
foreach($product as $con){ 
	
	echo '<tr><td>'.$i.'</td><td><a href="'.base_url().'admin/gallery/edit/'.$con['id'].'">'.$con['title'].'</a></td><td>'.$con['type'].'</td><td>'.$con['status'].'</td>';
?>
