									...
									for($r=1;$r<=4;$r++)
                        {
                                   echo ' <div class="form-group col-md-12">
                                        <label class=" control-label" for="'.$i.'1"></label>  
                                            ...
                                            <input id="'.$i.'1" name="'.$i.'1" placeholder="" value="'.$con['quizoption'].'" class="form-control input-md" type="text">
