...
<input type="hidden" value="<?php echo $user['image']; ?>" name="image_old">
		  ...
		  <div class="form-group col-sm-2">
<?php if($user['image'] !='') { echo '<img src="https://www.stakein.co.in/images/user/'.$user['image'].'" width="50" height="50">'; } ?>
</div>
...
<div class="form-group col-sm-2">
        ...
        <div class="form-group col-sm-2">
		  ...
		  <div class="form-group col-sm-2">
           <?php if($user['panimage'] !='') { echo '<a href="https://www.stakein.co.in/images/user/'.$user['panimage'].'" target="_blank"><img src="https://www.stakein.co.in/images/user/'.$user['panimage'].'" style="width:auto;max-width:64px;"></a>'; } ?>
          </div>
        ...
        <div class="form-group col-sm-6">
		  ...
		  <div class="form-group col-sm-2">
           <?php if($user['aadharimage'] !='') { echo '<a href="https://www.stakein.co.in/images/user/'.$user['aadharimage'].'" target="_blank"><img src="https://www.stakein.co.in/images/user/'.$user['aadharimage'].'" style="width:auto;max-width:64px;"></a>'; } ?>
          </div>
        ...
        <input type="hidden" name="oldpassword" value="<?php echo $user['pass_word']; ?>">
		  ...
		  <input type="hidden" name="bliss_amount" value="<?php echo $user['bliss_amount']; ?>">
		   ...
		   <div class="form-group  col-sm-12">
            <p><input type="checkbox" name="terms" checked  value="yes"> By clicking become an distributor, you are agreeing to the privacy policy and the terms & conditions of the Campus4Success</p>
          </div>
