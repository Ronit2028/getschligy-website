	 ...
	 //form data
      ...
      echo form_open_multipart('admin/ytb/edit/'.$this->uri->segment(4).'', $attributes);
	  $prod = $product[0];
	  ?>
      <div class="page-heading"> 
        <h2 class="iod">Update Gallery URL <ul class="list-inline"><li><a class="btn btn-primary btn-sm" href="<?php echo base_url().'admin/ytb'; ?>">&laquo; Back</a></li><li><button type="submit" class="btn btn-primary btn-sm">Save</button></li><li><button type="submit" class="btn btn-primary btn-sm">Save & Continue</button></li></h2>
		...
		<div class="form-group col-sm-12">
		 ...
		 <div class="form-group col-sm-12">
          <label  class="control-label col-sm-3">URL <small style="color:red">*</small></label>
             <div class="col-sm-9"> <input type="text" class="form-control" required name="url" value="<?php if($this->input->post('url')!='') { echo $this->input->post('url'); } else { echo $prod['url']; }  ?>" >
          </div>
          </div>
		 ...
		 <div class="form-group col-sm-12">
           ...
           <label  class="control-label col-sm-3">Description <small style="color:red">*</small></label>
			<div class="col-sm-9">
              <textarea class="form-control" required="required" name="description" value="<?php if($this->input->post('description')!='') { echo $this->input->post('description'); }  else { echo $prod['description']; }   ?>" ></textarea>
			</div>
          </div>
		  
		  <div class="form-group col-sm-12">
           <label  class="control-label col-sm-3">Target <small style="color:red">*</small></label>
             <div class="col-sm-9">  <select name="type" class="form-control custom-select">
			 <option  value="gallery">Gallery</option>
			<option <?php if($prod['type'] == 'home') { echo "selected"; } ?> value="home">Home Page</option>
          ...
          <div class="form-group">
            <button class="btn btn-primary" type="submit">Save</button> &nbsp; 
			 <a class="btn btn-primary" href="<?php echo base_url().'admin/ytb'; ?>">Cancel </a>
          </div>
		  </div>
        </fieldset>
      <?php echo form_close(); ?>
