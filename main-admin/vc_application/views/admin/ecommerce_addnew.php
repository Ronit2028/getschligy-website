	 ...
	 //form data
      ...
      echo form_open_multipart(base_url().'admin/ecommerce/add', $attributes);
	  ?>
      <div class="page-heading"> 
        <h2 class="iod">Add product <ul class="list-inline"><li><a class="btn btn-primary btn-sm" href="<?php echo base_url().'admin/product'; ?>">&laquo; Back</a><li><button type="reset" class="btn btn-primary btn-sm">Reset</button><li><button type="submit" class="btn btn-primary btn-sm">Save</button><li><button type="submit" class="btn btn-primary btn-sm">Save & Continue</button></li><li><button class="btn btn-primary btn-sm show-attributes" type="button">Creat New Attribute</button></li></h2>
...
<div class="col-sm-12">	 
		...
		<h2></h2>
		  ...
		  <div class="form-group col-lg-6 col-mg-6 col-sm-6">
            <label  class="control-label col-sm-5">Procurement Cost</label>
             <div class="col-sm-7"> <input type="number" required="required"  step="0.01" class="form-control"  name="cost" value="<?php if($this->input->post('cost')!='') { echo $this->input->post('cost'); }  ?>" >
          </div> 
          </div> 
		  
		   <div class="form-group col-lg-6 col-mg-6 col-sm-6">
            <label  class="control-label col-sm-5">Selling Price</label>
             <div class="col-sm-7"> <input type="number" class="form-control"  step="0.01"  name="p_d_price" value="<?php if($this->input->post('p_d_price')!='') { echo $this->input->post('p_d_price'); }  ?>" >
          </div> 
          </div> 
			
			<div class="form-group col-lg-6 col-mg-6 col-sm-6">
            <label  class="control-label col-sm-5">PV</label>
             <div class="col-sm-7"> <input type="number" class="form-control"  step="0.01"  name="comm_dis" value="<?php if($this->input->post('comm_dis')!='') { echo $this->input->post('comm_dis'); }  ?>" >
          </div> 
          </div> 
		  <div class="form-group col-lg-6 col-mg-6 col-sm-6">
            <label  class="control-label col-sm-5">BV</label>
             <div class="col-sm-7"> <input type="number" class="form-control"  step="0.01"  name="bv" value="<?php if($this->input->post('bv')!='') { echo $this->input->post('bv'); }  ?>" >
          </div> 
          </div> 
  ...
  <div class="form-group col-sm-12">
            <label  class="control-label">Description</label>
               <textarea class="form-control myTextarea2" name="p_description"><?php if($this->input->post('p_description')!='') { echo $this->input->post('p_description'); } ?></textarea>
          </div>
