	 ...
	 //form data
      ...
      echo form_open_multipart('admin/gallery/edit/'.$this->uri->segment(4).'', $attributes);
	  $prod = $product[0];
	  ?>
      <div class="page-heading"> 
        <h2 class="iod">Update Gallery <ul class="list-inline"><li><a class="btn btn-primary btn-sm" href="<?php echo base_url().'admin/gallery'; ?>">&laquo; Back</a></li><li><button type="submit" class="btn btn-primary btn-sm">Save</button></li><li><button type="submit" class="btn btn-primary btn-sm">Save & Continue</button></li></h2>
		  ...
		  <div class="form-group col-sm-12">
           <label  class="control-label col-sm-3">Status <small style="color:red">*</small></label>
            ...
            <label  class="control-label">Description</label>
               <textarea class="form-control textarea-editor" name="description"><?php if($this->input->post('description')!='') { echo $this->input->post('description'); } else { echo $prod['description']; } ?></textarea>
          </div>
		  ...
		  <div class="form-group col-sm-12">
           <label  class="control-label col-sm-3">type <small style="color:red">*</small></label>
             <div class="col-sm-9">  <select name="type" class="form-control custom-select">
			  <option <?php if($prod['type']=='achiever') { echo 'selected="selected"'; } ?> value="achiever">achiever</option>
			  <option <?php if($prod['type']=='gallery') { echo 'selected="selected"'; } ?> value="gallery">gallery</option>
			  </select>
          </div> 
          </div> 
