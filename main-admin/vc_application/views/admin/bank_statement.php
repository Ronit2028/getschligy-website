...
<thead> <tr> <th>S. No.</th><th>Transaction ID</th><th>Name</th><th>Amount</th><th>Bank Name</th><th>Bank A/c No</th><th>IFSC</th><th>Pan No</th><th>Date</th></tr> </thead> 
<tbody> 
<?php 
$i = 1;
...
foreach($payouts as $con){ 
	...
	echo '<tr '.$class.'><td>'.$i.'</td><td>'.$con['bank_tran'].'</td><td>'.$con['f_name'].' '.$con['l_name'].' ('.$con['customer_id'].')</td><td>Rs. '.$payable.'</td><td>'.$con['bank_name'].'</td>
