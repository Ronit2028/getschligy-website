	 ...
	 //form data
      ...
      <div class="page-heading"> 
        <h2 class="iod">Update Combo Pack <ul class="list-inline"><li><a class="btn btn-primary btn-sm" href="<?php echo base_url().'admin/product'; ?>">&laquo; Back</a></li><li><button type="submit" class="btn btn-primary btn-sm">Save</button></li><li><button type="submit" class="btn btn-primary btn-sm">Save & Continue</button></li><li><button class="btn btn-primary btn-sm show-attributes" type="button">Creat New Attribute</button></li></h2>
			 ...
			 <option value="">Select</option>
			  <?php if(!empty($tax)) {
				  foreach($tax as $value) {
					 ...
					 if($prod['t_class']==$value['id']) { echo ' selected="selected" '; }
		  ...
		  <div class="form-group col-lg-6 col-mg-6 col-sm-6">
		   ...
		   <div class="form-group col-lg-6 col-mg-6 col-sm-6">
            ...
            <label  class="control-label col-sm-5">PV</label>
             <div class="col-sm-7"> <input type="number"  step="0.0001" required="required" class="form-control"  name="comm_dis" value="<?php if($this->input->post('comm_dis')!='') { echo $this->input->post('comm_dis'); } else { echo $prod['comm_dis']; }  ?>" >
          </div> 
          </div>
		  <div class="form-group col-lg-6 col-mg-6 col-sm-6">
            <label  class="control-label col-sm-5">BV</label>
             <div class="col-sm-7"> <input type="number" step="0.0001" required="required" class="form-control"  name="bv" value="<?php if($this->input->post('bv')!='') { echo $this->input->post('bv'); } else { echo $prod['bv']; }  ?>" >
          </div> 
          </div>
