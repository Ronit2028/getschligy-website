...
<thead> <tr> <th>S. No.</th><th>Reward</th><th>User</th><th>User ID</th><th>Date</th><th>Status</th> <th></th></tr> </thead> 
<tbody> 
<?php 
$i = 1;
...
<div class="col-sm-12">
 ...
 <div class="form-group col-sm-3">    
<p class="text-left"><input type="submit" class="btn btn-primary" name="update_req" value="Update"> </p>
</div>
</div>
</div>
 <?php echo form_close(); ?>
