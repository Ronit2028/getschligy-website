...
hr{border:1px solid #bbb}
	...
	<table class="table border" border="1" cellspacing="0" cellpadding="5">
	  <tr>
	  <td colspan="4"><img src="<?php echo base_url(); ?>/assets/images/logo.png" class="img-responsive" width="200px"></td>
	  ...
	  <td colspan="3">
	  <b>Stake In Trade Ventures Pvt. Ltd.</b>
            <p>Plot No. 1722, Sector 82, JLPL Inustrial Area, </p>
            <p>Mohali - 140 308, Punjab</p>
            <p>Call: +91- **************</p>
			<p>Email : csr@stakein.co.in </p>
			<p>Website : www.stakein.co.in</p>
	</td>
...
<div class="col-sm-12 text-right" style="margin-top:15px">Stake In Trade Ventures Pvt. Ltd</div>
