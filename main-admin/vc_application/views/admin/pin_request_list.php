...
foreach($customer as $con){ 
	...
	echo '<tr class='.$st.'><td>'.$i.'</td><td><a href="'.base_url().'admin/pin_request/edit/'.$con['id'].'">'.$con['customer_id'].'</a></td><td>'.$con['email'].'</a></td><td>'.$con['name'].'</td><td>'.$con['neft'].'</td><td>'.$con['amount'].'</td><!-- <td>'.$con['bank_name'].'</td><td>'.$con['bank_branch'].'</td> ---><td>'.$con['status'].'</td>';
